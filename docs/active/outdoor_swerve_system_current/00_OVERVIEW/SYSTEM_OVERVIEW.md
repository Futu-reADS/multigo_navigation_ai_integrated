...
**Reference Architecture:** Inspired by proven ParcelPal approach (0% code, 60% patterns; NOT Autoware)
...
#### **3. Navigation Stack** (NEW CODE, ParcelPal-inspired Architecture)
- Manual SLAM mapping once (offline with loop closure)
- NDT scan matcher localization (standard ROS 2, NOT Autoware)
- Nav2 path planning and obstacle avoidance
- Range: 500m-1km without GPS
- **Note:** 0% code from ParcelPal, 70% architectural patterns

#### **4. Perception System** (NEW CODE, ParcelPal-inspired Architecture)
...
- Binary obstacle detection (PCL-based, NO deep learning)
- **Note:** 0% code from ParcelPal, 60% architectural patterns
