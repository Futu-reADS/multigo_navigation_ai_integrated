...
この文書は、ArUcoマーカーベースのビジュアルサーボイングを使用して精密な車椅子接続を可能にする自律ドッキングコントローラーの詳細設計仕様を提供します。
...
**計算バジェット:**
- ArUco検出: <50ms @ 10 Hz（カメラごと）
- ビジュアルサーボ計算: <5ms @ 20 Hz
- 総CPU使用率: GMKtec Nucbox K6で<15%
...
**文書ステータス:** ドラフト
**実装ステータス:** 開発準備完了
**必要な承認:** ナビゲーションリード、ビジョンエンジニア、安全リード
