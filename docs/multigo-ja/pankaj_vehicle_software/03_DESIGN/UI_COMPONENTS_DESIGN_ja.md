...
本ドキュメントは、ROS 2通信のためのrosbridge WebSocket統合を備えたReact 18 + Next.js 14アプリケーションを実装する、タッチスクリーンUIの詳細設計仕様を提供します。
...
**デプロイメント:** Ubuntu 22.04上でChromiumキオスクモード
